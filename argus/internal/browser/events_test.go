...
func TestEventFormattersProtectBrowserPrivacy(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"visual action", browser.FormatAction("visual_click", map[string]any{"description": "private target description"}), map[string]any{"tool": "visual_click", "arguments": map[string]any{}}},
		...
		{"visual observation", browser.FormatObservation("visual_click", map[string]any{"url": "https://example.com/a?token=secret", "action": "visually clicked", "path": "/screenshots/run/after.png", "snapshot": map[string]any{"text": "private"}}), map[string]any{"tool": "visual_click", "result": map[string]any{"url": "https://example.com/a", "action": "visually clicked", "path": "/screenshots/run/after.png"}}},
	} {
